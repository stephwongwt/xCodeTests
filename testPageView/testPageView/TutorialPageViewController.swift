...
class TutorialPageViewController: UIPageViewController {
    ...
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        ...
        return [self.newColoredViewController("blueVC"),
                self.newColoredViewController("greenVC"),
                self.newColoredViewController("redVC")]
    }()
    ...
    private func newColoredViewController(storyBoardIdentifier: String) -> UIViewController {
